        ...
        */
          ...
          events: {
            cellNav: {
              ...
              */
              ...
              navigateToRow: function (newRow, oldRow) {},
              /**
              * @ngdoc event
        ...
        defaultGridOptions: function (gridOptions) {
          ...
          */
          ...
          gridOptions.rowNavEnabled = true;
...
//                  newRowCol = uiGridCtrl.cellNav.makeRowCol(newRowCol); ????
                ...
                uiGridCtrl.cellNav.broadcastRowFocus = function (row, modifierDown, originEvt) {
                  modifierDown = !(modifierDown === undefined || !modifierDown);
                  var rowSelectIndex = uiGridCtrl.grid.api.cellNav.rowSelectIndex(row);
                  ...
                  if (grid.cellNav.lastRow === null || rowSelectIndex === -1) {
                    ...
                    if (uiGridCtrl.grid.options.modifierKeysToMultiSelectCells && modifierDown) {
                      ...
                      grid.cellNav.focusedRows = [row];
                    }
                  } else if (grid.options.modifierKeysToMultiSelectCells && modifierDown &&
                    rowSelectIndex >= 0) {

                      grid.cellNav.focusedRows.splice(rowSelectIndex, 1);
                    }
                  };
